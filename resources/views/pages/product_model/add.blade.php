        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('product_modelIndex') }}" style="color: #007bff;">@lang('cruds.product_model.title')</a></li>
...
<div class="row">
    <div class="col-8 offset-2">
        <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form action="{{ route('product_modelCreate') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-6 mb-2">
                                ...
                                <select class="form-control select2" style="width: 100%;" name="brand_id" value="{{ old('brand_id') }}">
