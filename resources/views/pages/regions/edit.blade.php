...
<div class="row">
    <div class="col-8 offset-2">
        <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form action="{{ route('regionUpdate', $region->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row">
                            @foreach(config('constants.locales') as $locale)
                                <div class="col-12 col-lg-6 mb-2">
                                    ...
                                    value="{{ old('name_' . $locale['short_name']) ?? $region->{'name_' . $locale['short_name']} }}" placeholder="Название" required>
                                </div>
                            @endforeach
                        </div>
                    </div>
