                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('roleCreate') }}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" placeholder="@lang('cruds.role.fields.name')" value="{{ old('name') }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" name="title" type="text" id="title" placeholder="@lang('cruds.role.fields.title')" value="{{ old('title') }}">
                        </div>
