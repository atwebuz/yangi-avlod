...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">@lang('cruds.brands.title')</h4>

            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="{{ route('home') }}" style="color: #007bff;">@lang('global.home')</a></li>
                    <li class="breadcrumb-item active">@lang('cruds.brands.title')</li>
                </ol>
            </div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">@lang('cruds.brands.title')</h3>
                <a href="{{ route('brandAdd') }}" class="btn btn-sm btn-success waves-effect waves-light float-right">
                            ...
                            <tr>
                                ...
                                <td>
                                    @if(!is_null($item->photo))
                                        <a target="_blank"  href="{{ url('/') }}/images/brands/{{ $item->photo }}">{{ $item->photo }}</a>
                                    @else
                                        @lang('global.empty')
                                    @endif
                                </td>
                                ...
                                <td class="text-center">
                                    <form action="{{ route('brandDestroy',$item->id) }}" method="post">
                                        @csrf
                                        <ul class="list-unstyled hstack gap-1 mb-0">
                                            ...
                                            <li data-bs-toggle="tooltip" data-bs-placement="top" title="@lang('global.edit')">
                                                <a href="{{ route('brandEdit',$item->id) }}" class="btn btn-info">
                                                    ...
                                                    <table class="table table-striped">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    @if(!is_null($item->photo))
                                                                        <a target="_blank"  href="{{ url('/') }}/images/brands/{{ $item->photo }}">
                                                                        
                                                                            <img class="w-100" src="{{ url('/') }}/images/brands/{{ $item->photo }}" alt="">
                                                                        </a>
                                                                    @else
                                                                        @lang('global.empty')
                                                                    @endif
