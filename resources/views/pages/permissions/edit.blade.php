                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('permissionUpdate',$permission->id) }}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" placeholder="@lang('cruds.permission.fields.name')" value="{{ old('name',$permission->name) }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" name="title" type="text" id="title" placeholder="@lang('cruds.permission.fields.title')" value="{{ old('title',$permission->title) }}">
                        </div>
