        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('api-userIndex') }}" style="color: #007bff;">@lang('cruds.user.title')</a></li>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('api-userCreate') }}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" placeholder="Имя пользователя" value="{{ old('name') }}" required>
                        @if($errors->has('name'))
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control {{ $errors->has('token_valid_period') ? 'is-invalid':'' }}" type="number" max="999999" min="1" name="token_valid_period" id="token_valid_period" placeholder="Срок действия токена" value="{{ old('token_valid_period',30) }}">
