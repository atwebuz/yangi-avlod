    ...
    <div class="hero-section">
        <div class="hero-container">
            ...
            "
                                ...
                                <source data-srcset="{{ asset('front-assets/images/banner/img1.jpg') }}"
                                    srcset="{{ asset('front-assets/images/banner/img1.jpg') }}" media="(min-width: 0px)" />
                                <img class="swiper-lazy hero-slide-img"
                                    data-src="{{ asset('front-assets/images/banner/img1.jpg') }}"
            ...
            "
                                    media="(min-width: 0px)" />
                                <img class="swiper-lazy hero-slide-img"
                                    data-src="{{ asset('front-assets/images/banner/img2.jpg') }}"
            ...
            "
                                    media="(min-width: 0px)" />
                                <img class="swiper-lazy hero-slide-img"
                                    data-src="{{ asset('front-assets/images/banner/img3.jpg') }}"
                        ...
                        <div class="hero-slide swiper-slide" id="bx_3963854015_18583">
                            <picture class="lazy-img-wrap hero-slide-img-wrap">
                                <source data-srcset="https://rodina-geroya.ru/wp-content/uploads/2614113701240961.jpg"
                                    srcset="
            ...
            <div class="about-slider-container container">
                ...
                "
                                        ...
                                        <img class="swiper-lazy about-slide-img"
                                            ...
                                            src="{{ asset('front-assets/images/park/img4.jpg') }}"
...
" />
                ...
                "
                                        ...
                                        <img class="swiper-lazy about-slide-img"
                                            ...
                                            src="{{ asset('front-assets/images/park/img6.jpg') }}" alt="Пожарное депо" />
                                    </picture>
                                    <div class="about-slide-body">
                                ...
                                <ul class="nav nav-tabs" role="tablist">
                                    <li class="nav-item">
                                        <div class="nav-link" id="ID4157421150-LINK2" data-toggle="tab"
                                            data-target="#ID4157421150-TAB2" role="tab" aria-selected="true">
                                            Налаживание производства
                                        </div>
                                    </li>
                                    <li class="nav-item">
                                        <div class="nav-link" id="ID4157421150-LINK5" data-toggle="tab"
                                            data-target="#ID4157421150-TAB5" role="tab" aria-selected="false">
                                            Расширение проектов
                                        </div>
                                    </li>
                                    <li class="nav-item">
                                        <div class="nav-link" id="ID4157421150-LINK4" data-toggle="tab"
                                            data-target="#ID4157421150-TAB4" role="tab" aria-selected="false">
                                            Создание инфраструктуры
                                        </div>
                                    </li>
                                    <li class="nav-item">
                                        <div class="nav-link" id="ID4157421150-LINK3" data-toggle="tab"
                                            data-target="#ID4157421150-TAB3" role="tab" aria-selected="false">
                                            Увеличение объема развития
                                        </div>
                                    </li>
                                    <li class="nav-item">
                                        <div class="nav-link" id="ID4157421150-LINK1" data-toggle="tab"
                                            data-target="#ID4157421150-TAB1" role="tab" aria-selected="false">
                                                ...
                                                <div class="advantages-card-container"
                                                    ...
                                                    <div class="advantages-card-body">
                                                        <div class="statistics-card statistics-card--small">
                                                            <div class="statistics-card-container">
                                                                <div class="statistics-card-value" data-unit=""></div>
    ...
    <div class="partner-slider-section">
        <div class="partner-slider-container container">
            ...
            <div class="swiper partner-slider js-partner-slider">
                <div class="swiper-container js-swiper-slider">
                    <div class="swiper-wrapper">
                        <a class="lazy-img-wrap partner-slide swiper-slide" target="_blank" href="#" aria-label>
                        ...
                        <a class="lazy-img-wrap partner-slide swiper-slide" target="_blank" href="#" aria-label>
                            <img class="swiper-lazy partner-slide-img"
                                src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                                data-src="{{ asset('front-assets/images/logo/img1.png') }}"
                                alt="Toshkent Shahar Hokimligi" />
                        </a>
                        <a class="lazy-img-wrap partner-slide swiper-slide" target="_blank" href="#" aria-label>
                            <img class="swiper-lazy partner-slide-img"
                                src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
